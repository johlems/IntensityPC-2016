...
<table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                ...
                <p><a href="add_new_user_type.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Add User Type</a></p>
                                <thead>
                                    <tr>
                                      <th><strong><font color="white">User Type</font></strong></th>  
                                        <th><strong><font color="white">Actions</font></strong></th> 
                                    </tr>
                                </thead>
                                <tbody>
       <?php  $user_query=mysql_query("select * from user_type")or die(mysql_error());
             ...
             ?>
                  <tr class="del<?php echo $id ?>">
                    <td><font color="white"><strong><?php echo $row['user_type']; ?></strong></font></td>
                                    <td>
