...
<div class="well">
  ...
  if (isset($_POST['submit'])) {
    ...
    mysql_query("update tb_products set name='$name',price='$price',details='$description',quantity='$quantity'
    ...
    mysql_query("insert into audit_trail(ID,User,Date_time,Outcome,Detail)values
      ('$userID','$user','$date','Updated','$detail')");
