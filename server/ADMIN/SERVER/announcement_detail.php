    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
          ...
          <p class="pull-right visible-xs">
           ...
           <div class="jumbotron">
            <center><h2>Intensity PC | SALES and REPAIR</h2></center>
          </div>
 ...
 <?php
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a class="btn btn-primary" href="#">Apply Now .. <i class="fa fa-angle-left"></i></a>
                <a class="btn btn-primary" href="#">Check Out .. <i class="fa fa-angle-left"></i></a>
            </div>
