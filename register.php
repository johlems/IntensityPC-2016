...
function cap()
{
    ...
    function allLetter(inputtxt) {
      var letters = /^[A-Za-z]+$/;
      if(inputFname.value.match(letters)) {
...
function cap1()
{
    ...
    function allLetter(inputtxt) {
      var letters = /^[A-Za-z]+$/;
      if(inputmiddlename.value.match(letters)) {
        alert('Your name have accepted : you can try another');
        return true;
      }
      else
...
function cap2()
{
    ...
    function allLetter(inputtxt) {
      var letters = /^[A-Za-z]+$/;
      if(inputLname.value.match(letters)) {
        alert('Your name have accepted : you can try another');
        return true;
      }
      else
  ...
  <div class="control-group">
    ...
    <div class="controls">
      ...
      <input type="checkbox" id="show-hide" name="show-hide" value="" />
      <script src ="checkbox2.js"> </script>
    </div>
  </div> <!-- End of Show/Hide Password -->
...
function cap3()
{
    ...
    document.getElementById("address").value = str.charAt(0).toUpperCase() + str.slice(1);
		...
		<div class="control-group">
			<label class="control-label" for="bldg no">Bldg No. *</label>
			<div class="controls">
			  <input type="text" name="bldg no." onkeydown="cap3()" id="bldg no." placeholder="Bldg No." required/> 
			</div>

      <br>
      <label class="control-label" for="street">Street *</label>
      <div class="controls">
        <input type="text" name="street" onkeydown="cap3()" id="street" placeholder="Street" required/> 
      </div>

      <br>
      <label class="control-label" for="barangay">Barangay *</label>
      <div class="controls">
        <input type="text" name="barangay" onkeydown="cap3()" id="barangay" placeholder="Barangay" required/> 
      </div>
      ...
      <div class="controls">
        <input type="text" name="zip code" onkeydown="cap3()" id="zip code" placeholder="Zip code" required/> 
      </div>
		</div>
      ...
      <div class="controls">
        <input type="text"  name="cnumber" id="phone" placeholder="(02)" required/>
      </div>

      <br>

      <div class="control-group">
        <label class="control-label" for="phone">Cellphone Number *</label>
        <div class="controls">
          <input type="text"  name="cnumber" id="cphone" placeholder="(+63)" required/>
        </div>
      </div>
